...
export function BottomNav({ activeTab, onNavigate }: BottomNavProps) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 px-4 pb-4 pt-2">
      <div className="mx-auto max-w-md rounded-[28px] border border-white/10 bg-[rgba(15,15,18,0.94)] p-2 shadow-[0_18px_60px_rgba(0,0,0,0.42)] backdrop-blur-xl">
